...
const InfoListItem: React.FC<{ title: string; description: string }> = ({ title, description }) => (
  <li>
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 font-sans">
      ...
      <main className="p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <h2 className="text-xl font-semibold text-gray-200">Informações Obrigatórias</h2>
